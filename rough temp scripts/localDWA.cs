...
{    
    ...
    { 
        ...
        private const float MAX_LIN_VEL = 1.0f; // maximum linear velocity [m/s]
        ...
        private void checkDone()
        {
            ...
            // out of designed environment
            if (cur_vehiclePos[0] < -10.0f || cur_vehiclePos[0] > 10.0f)
                check_done = true;

            if (cur_vehiclePos[1] < -10.0f || cur_vehiclePos[1] > 10.0f)
                check_done = true;
        }
